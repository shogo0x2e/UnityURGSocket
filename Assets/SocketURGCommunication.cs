...
public class SocketURGCommunication : MonoBehaviour
{
    ...
    private string ReadData()
    {
        ...
        do
        {
            int byteData = socket.Receive(new byte[] { 0 }, 0, 1, SocketFlags.None);
            char buf = (char)byteData;
